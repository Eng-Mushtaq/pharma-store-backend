...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user)
    {
        ...
        $user->assignRole($request->role);
        $notification = notify('تم تعديل المستخدم بنجاح');
    ...
    public function updateProfile(Request $request,User $user){
        ...
        $notification = notify('تم تحديث الملف بنجاح');
    ...
    public function updatePassword(Request $request, User $user)
    {
        ...
        if ($verify_password) {
            ...
            $notification = notify('تم تحديث كلمة مرور المستخدم بنجاح!!!');
            $logout = auth()->logout();
            return back()->with($notification, $logout);
        } elseif(!$verify_password) {
            $notification = notify("كلمة مرور قديمة او غير صحيحة!!!",'danger');
