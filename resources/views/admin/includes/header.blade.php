		...
		<li class="nav-item dropdown noti-dropdown">
			...
			<div class="dropdown-menu notifications">
				<div class="topnav-dropdown-header">
					...
					<a href="{{route('mark-as-read')}}" class="clear-noti">تحديد الكل ك مقروء </a>
				</div>
								...
								<a href="{{route('read')}}">
									<div class="media">
										...
										<div class="media-body">
											<h6 class="text-danger">تنبيهات المخزون</h6>
											<p class="noti-details">
												<span class="noti-title">{{$notification->data['product_name']}} فقط {{$notification->data['quantity']}} متبقي.</span>
												<span>يرجى تحديد كمبة المشتريات </span>
											</p>
